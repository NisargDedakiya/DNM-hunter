    ...
    <div className={styles.guardrailOverlay}>
      <div className={styles.gateModal}>
        ...
        <p className={styles.gateMessage}>
          DNM-Hunter needs at least one LLM provider (DeepSeek, Anthropic, OpenAI, ...) before
  ...
  return (
    <div className={styles.guardrailOverlay}>
      <div className={styles.gateModalWide}>
        ...
        <p className={styles.gateMessage}>
          Choose the models DNM-Hunter will use for this project. We&apos;ll remember them as the
